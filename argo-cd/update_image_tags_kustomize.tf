...
resource "octopusdeploy_process" "update_image_tags_kustomize" {
  project_id = octopusdeploy_project.update_image_tags_kustomize.id
  space_id   = octopusdeploy_space.main.id
}

resource "octopusdeploy_process_step" "update_image_tags_kustomize" {
  process_id = octopusdeploy_process.update_image_tags_kustomize.id
  space_id   = octopusdeploy_space.main.id
