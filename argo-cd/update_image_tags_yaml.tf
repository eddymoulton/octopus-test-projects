resource "octopusdeploy_project" "update_image_tags_yaml" {
  ...
  name                                 = "Update Image Tags Yaml"
  tenanted_deployment_participation    = "Untenanted"
  included_library_variable_sets       = []
  project_group_id                     = octopusdeploy_project_group.argo_cd_samples.id
}

resource "octopusdeploy_process" "update_image_tags_yaml" {
  project_id = octopusdeploy_project.update_image_tags_yaml.id
  space_id   = octopusdeploy_space.main.id
}

resource "octopusdeploy_process_step" "update_image_tags_yaml" {
  process_id = octopusdeploy_process.update_image_tags_yaml.id
  space_id   = octopusdeploy_space.main.id
