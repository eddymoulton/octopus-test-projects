...
resource "octopusdeploy_process" "update_manifests_helm_playhq" {
  project_id = octopusdeploy_project.update_manifests_helm_playhq.id
  space_id   = octopusdeploy_space.main.id
}

resource "octopusdeploy_process_step" "update_manifests_helm_playhq" {
  process_id = octopusdeploy_process.update_manifests_helm_playhq.id
  space_id   = octopusdeploy_space.main.id
