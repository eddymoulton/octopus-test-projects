...
resource "octopusdeploy_process" "update_manifests_kustomize" {
  project_id = octopusdeploy_project.update_manifests_kustomize.id
  space_id   = octopusdeploy_space.main.id
}

resource "octopusdeploy_process_step" "update_manifests_kustomize" {
  process_id = octopusdeploy_process.update_manifests_kustomize.id
  space_id   = octopusdeploy_space.main.id
