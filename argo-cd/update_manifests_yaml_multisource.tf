...
resource "octopusdeploy_process" "update_manifests_yaml_multisource" {
  project_id = octopusdeploy_project.update_manifests_yaml_multisource.id
  space_id   = octopusdeploy_space.main.id
}

resource "octopusdeploy_process_step" "update_manifests_yaml_multisource" {
  process_id = octopusdeploy_process.update_manifests_yaml_multisource.id
  space_id   = octopusdeploy_space.main.id
